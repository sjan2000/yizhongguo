...
//'system.order.tracking'=>array('type'=>SET_T_BOOL,'default'=>'false','desc'=>app::get('b2c')->_('是否启用订单跟踪查询'),'helpinfo'=>'<span class=\'notice\' style=\'display:inline-block;vertical-align:top;margin-left:10px;\'>'.app::get('b2c')->_('说明：目前Jinding Yun Art订单物流跟踪查询功能是采用快递100提供的免费API接口，该接口目前使用限制为2000次/天，<br>若商家需要无限制或使用其它快递查询接口服务，请另行咨询快递100或其它服务商获取。<br>参考：http://www.kuaidi100.com/help/qa.shtml#qa06').'</span>'),
